<?
	...
	if (strlen($last_img) !== 0) {
		...
		echo "<a href='" . $last_img . "' target='_blank'><img src='" . $last_img . "' class='embed_img'></a>";
    ...
    if (strlen($last_link) != 0 || strlen($last_tpimg) != 0) {
		...
		if (strpos($last_link, 'youtube.com/') !== false || strpos($last_link, 'youtu.be/') !== false) {
			...
			if (strlen($last_img) !== 0) { // null
				...
				echo "<a href='" . $last_link . "' target='_blank'><img src='" . $last_link . "' class='embed_img'></a>";
				echo "<div class='space_img_bot'></div>";
			}
    ...
    // permalink date
    echo "<a href='index.php?miter=" . $var_id . "' class='permalink' style='color:silver;'>" . $last_odate . "</a><br />";
	...
	if($login == true) {
        ...
        echo "<a href='index.php?quote=" . $quote_protocol . "://" . $quote_host . "/index.php?miter=" . $var_id . "'><img src='but/quote.jpg' class='footer_button_img' title='Quote'></a>";
		} else {

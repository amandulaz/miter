	...
	<tr>
		<td class='static_td'>
			...
			<table class='setting_table'>
				<tr>
					<td>
						<form name="miter_color_form" action="scr/color.php" method="POST">
						<input type="color" id="miter_color" name="miter_color" class="settings_color_field" value="<? 
							echo $user_bg;
							?>">
			...
			<table class='setting_table'>
				<tr>
					<td>
						<form name="miter_header_form" action="scr/color_header.php" method="POST">
						<input type="color" id="miter_color_header" name="miter_color_header" class="settings_color_field" value="<? 
							echo $user_header;
						?>">
			...
			<table class='setting_table'>
				<tr>
					<td>
						<form name="miter_border_form" action="scr/color_border.php" method="POST">
							<input type="color" id="miter_color_border" name="miter_color_border" class="settings_color_field" value="<? 
								echo $user_border;
							?>">
			...
			<table class='setting_table'>
				<tr>
					<td>
						<form name="miter_link_form" action="scr/color_link.php" method="POST">
							<input type="color" id="miter_color_link" name="miter_color_link" class="settings_color_field" value="<? 
								echo $user_link;
							?>">
	...
	<tr>
		<td class='static_td'>						
			...
			<table class='setting_table'>
				<tr>
					<td>
						<form name="miter_button_form" action="scr/delete_miter_archive.php" method="POST" target="_blank">

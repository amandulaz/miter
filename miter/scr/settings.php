					...
					<tr>
						<td>
							<form name="miter_favicon" action="scr/favicon.php" enctype="multipart/form-data" method="POST">
								<input name="favicon" type="file" id="favicon" class="settings_field_favicon">
					...
					<tr>
						<td>
							<form name="miter_button_form" action="scr/delete_archive.php" method="POST" target="_blank">
								<input type="submit" value="Delete Archive" class="settings_submit" style="background-color:#af7579;color:#fff;" onclick="return confirm('Delete Archive?!')">
							</form>
						</td>
					</tr>
				</table>

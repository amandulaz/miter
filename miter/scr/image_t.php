			...
			<table style='width:100%;padding:0;margin:0;border:0px solid #fff;'>
				...
				<?
					...
					foreach($file_list as $file_name) {
						...
						echo "<tr><td align='left'><span class='tenon'>" . $i++ . ". <a href='img/" . $file_name . "' target='_blank'>" . substr($file_name, 0, 30) . "</a></span>";
						echo "</td><td align='right'><span class='name'>" . formatbytes($file_size) . " <a href='scr/delete_image.php?d=" . $file_name . "' onclick='return confirm_delete()'>X</a></span>";
						echo "</td></tr>";
					}
				?>
			</table>
